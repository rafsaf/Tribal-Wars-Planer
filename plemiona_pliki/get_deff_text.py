...
def get_deff(new_Outline: models.New_Outline, radius, excluded_villages=""):
    """
    ...
    return deff_text(my_tribe_villages, enemy_tribe_villages, radius, new_Outline.zbiorka_obrona)
...
def deff_text(ally_villages, enemy_villages, radius, text_obrona):
    """
    ...
    for i in text_obrona.split("\r\n"):
        ...
        owner = wioska.get_player(150).name
