...
class InitialAddFirstTest(TestCase):
    ...
    def test_add_first_view_correct_behaviour(self):
        ...
        expected_path = reverse("base:planer_initial_detail", args=[outline.id, target.id]) + "?page=2&sort=nobleman_left"
        
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_add_first", args=[outline.id, target.id, weight_max.id])+"?page=2&sort=nobleman_left")
        ...
        # testing behaviour
        self.assertEqual(
            models.WeightModel.objects.filter(start="500|500", target=target).count(),
            2
        )
        ...
        new_weight = models.WeightModel.objects.filter(start="500|500", target=target).last()
    ...
    def test_add_first_fake_view_correct_behaviour(self):
        ...
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_add_first_fake", args=[outline.id, target.id, weight_max.id])+"?page=2&sort=nobleman_left")
    ...
    def test_add_last_view_correct_behaviour(self):
        ...
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_add_last", args=[outline.id, target.id, weight_max.id])+"?page=2&sort=nobleman_left")
    ...
    def test_add_last_fake_view_correct_behaviour(self):
        ...
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_add_last_fake", args=[outline.id, target.id, weight_max.id])+"?page=2&sort=nobleman_left")
    ...
    def test_initial_hide_weight_view_correct_behaviour(self):
        ...
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_hide_weight", args=[outline.id, target.id, weight_max.id])+"?page=2&sort=nobleman_left")
        ...
        response2 = self.client.post(reverse("base:planer_hide_weight", args=[outline.id, target.id, weight_max.id])+"?page=2&sort=nobleman_left")
    ...
    def test_initial_move_up_view_correct_behaviour(self):
        ...
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_move_up", args=[outline.id, target.id, weight1.id])+"?page=2&sort=nobleman_left")
        ...
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_move_up", args=[outline.id, target.id, weight0.id])+"?page=2&sort=nobleman_left")
    ...
    def test_initial_move_up_view_prevent_access_from_other_user(self):
        ...
        self.client.login(username="user2", password="user2")
        response = self.client.post(reverse("base:planer_move_up", args=[outline.id, target.id, weight.id])+"?page=2&sort=nobleman_left")
        self.assertEqual(response.status_code, 404)
    ...
    def test_initial_move_down_view_correct_behaviour(self):
        ...
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_move_down", args=[outline.id, target.id, weight0.id])+"?page=2&sort=nobleman_left")
        ...
        self.assertEqual(weight1.order, 0)
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_move_down", args=[outline.id, target.id, weight1.id])+"?page=2&sort=nobleman_left")
    ...
    def test_initial_move_down_view_prevent_access_from_other_user(self):
        ...
        self.client.login(username="user2", password="user2")
        response = self.client.post(reverse("base:planer_move_down", args=[outline.id, target.id, weight.id])+"?page=2&sort=nobleman_left")
        self.assertEqual(response.status_code, 404)
    ...
    def test_initial_weight_delete_view_correct_behaviour(self):
        ...
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_initial_delete", args=[outline.id, target.id, weight.id])+"?page=2&sort=nobleman_left")
    ...
    def test_initial_divide_view_correct_behaviour(self):
        ...
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_divide", args=[outline.id, target.id, weight.id, 4])+"?page=2&sort=nobleman_left")
        ...
        self.assertEqual(
            models.WeightModel.objects.filter(target=target).count(),
            6
        )
    ...
    def test_initial_divide_view_prevent_access_from_other_user(self):
        ...
        self.client.login(username="user2", password="user2")
        response = self.client.post(reverse("base:planer_divide", args=[outline.id, target.id, weight.id, 2])+"?page=2&sort=nobleman_left")
        self.assertEqual(response.status_code, 404)
    ...
    def test_planer_delete_target_view_correct_behaviour(self):
        ...
        expected_path = reverse("base:planer_initial", args=[outline.id]) + "?page=2&mode=add_and_remove"
        
        self.client.login(username="user1", password="user1")
        response = self.client.post(reverse("base:planer_delete_target", args=[outline.id, target.id])+"?mode=add_and_remove&page=2")
        ...
        self.assertEqual(
            models.TargetVertex.objects.filter(outline=outline, target="500|499").exists(),
            False
        )
    ...
    def test_planer_delete_target_view_prevent_access_from_other_user(self):
        ...
        self.client.login(username="user2", password="user2")
        response = self.client.post(reverse("base:planer_delete_target", args=[outline.id, target.id])+"?mode=add_and_delete&page=2")
        self.assertEqual(response.status_code, 404)
