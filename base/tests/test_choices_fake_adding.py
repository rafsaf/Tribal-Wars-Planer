...
class ChoicesFakeAdding(ChoicesInitial):
    def test_planer_add_first_fake_noble(self):
    ...
    def test_planer_add_first_fake(self):
    ...
    def test_planer_add_first_fake___prevent_access_from_other_user(self):
    ...
    def test_planer_add_last_fake_noble_view(self):
    ...
    def test_planer_add_last_fake_noble___prevent_access_from_other_user(self):
