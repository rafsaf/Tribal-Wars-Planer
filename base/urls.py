...
urlpatterns = [
    ...
    path(
        ...
        views.initial_planer,
        name="planer_initial",
    ),
    path(
        "planer/<int:id1>/complete",
        views.complete_outline,
