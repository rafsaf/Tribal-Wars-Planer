...
class TribeTagWithoutUnallowedPatterns(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.tribe = models.Tribe(1,3109,'Kaplica','0, 001',1,1,1,1,1,1)
    ...
    def test_All_Tribes_Dont_Have_Unallowed_Pattern_Tag_In_Tag(self):
        ...
        self.assertFalse(models.Tribe.objects.all().filter(tag__contains=self.unallowed_pattern_tag).exists())
