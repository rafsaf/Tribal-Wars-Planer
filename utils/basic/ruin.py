...
class RuinHandle:
    BIG_LEVELS: dict[str, int] = {
        BUILDING.HEADQUARTERS.value: 20,
        BUILDING.BARRACKS.value: 25,
        BUILDING.STABLE.value: 20,
        BUILDING.WORKSHOP.value: 10,
        BUILDING.ACADEMY.value: 1,
        BUILDING.SMITHY.value: 20,
        BUILDING.MARKET.value: 22,
        BUILDING.STATUE.value: 1,
        BUILDING.RALLY_POINT.value: 1,
        BUILDING.TIMBER_CAMP.value: 30,
        BUILDING.CLAY_PIT.value: 30,
        BUILDING.IRON_MINE.value: 30,
        BUILDING.FARM.value: 30,
        BUILDING.WAREHOUSE.value: 30,
        BUILDING.WALL.value: 20,
        BUILDING.WATCHTOWER.value: 20,
    }
    SMALL_LEVELS: dict[str, int] = {
        BUILDING.HEADQUARTERS.value: 20,
        BUILDING.BARRACKS.value: 18,
        BUILDING.STABLE.value: 10,
        BUILDING.WORKSHOP.value: 5,
        BUILDING.ACADEMY.value: 1,
        BUILDING.SMITHY.value: 20,
        BUILDING.MARKET.value: 15,
        BUILDING.STATUE.value: 1,
        BUILDING.RALLY_POINT.value: 1,
        BUILDING.TIMBER_CAMP.value: 25,
        BUILDING.CLAY_PIT.value: 25,
        BUILDING.IRON_MINE.value: 25,
        BUILDING.FARM.value: 25,
        BUILDING.WAREHOUSE.value: 24,
        BUILDING.WALL.value: 20,
        BUILDING.WATCHTOWER.value: 10,
    }
