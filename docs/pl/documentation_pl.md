...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/2_020_tamper2.png"  alt="Tampermonkey example2">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_020_target-ex2.png" alt="Targets example 2">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_030_target-ex3.png" alt="Targets example 3">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_120_mid-outline1.png" alt="Mid outline 1">
<br>
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_160_big-outline1.png" alt="Big outline 1">
<br>
...
<h5>Przykład wpisywanych celów:</h5>
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_180_big-outline3.png" alt="Big outline 3">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_190_big-outline4.png" alt="Big outline 4">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_200_ruin-targets.png" alt="Outline ruin1">

<h5>Przykład ustawień akcji burzącej, celujemy w 3 widoczne budynki w tej kolejności</h5>
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_210_ruin-panel.png" alt="Outline ruin1">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_220_ruin-show.png" alt="Outline ruin1">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/4_010_change-date.png" alt="Target mode change">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/4_040_change-mode1.2.png" alt="Target mode change 1">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/4_060_avoid-night.png" alt="Avoid night bonus tab">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/4_070_avoid-night2.png" alt="Avoid night bonus tab">
...
<img id="large" class="img-thumbnail" onclick="img_box(this)" style="max-height:250px;" src="/static/docs/pl/3_210_ruin-panel.png" alt="Ruin settings">
