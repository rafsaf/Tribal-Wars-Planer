...
class TestOutlineCreateTargets(TestCase):
    ...
    def test_fake_type_outline_guide_is_one_and_division_is_not_divide_split(self):
        self.outline.initial_outline_min_off = 500
        self.outline.mode_split = "split"
        self.outline.save()
        target = self.target()
    ...
    def test_fake_type_outline_guide_is_one_and_division_is_not_divide_together(self):
        self.outline.initial_outline_min_off = 500
        self.outline.mode_split = "together"
        self.outline.save()
        target = self.target()
    ...
    def test_fake_type_outline_guide_is_single_and_division_is_separatly_split(self):
        self.outline.initial_outline_min_off = 1000
        self.outline.mode_split = "split"
        self.outline.save()
        target = self.target()
    ...
    def test_fake_type_outline_guide_is_single_and_division_is_separatly_together(self):
        self.outline.initial_outline_min_off = 1000
        self.outline.mode_split = "together"
        self.outline.save()
        target = self.target()
