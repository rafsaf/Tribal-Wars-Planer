...
urlpatterns = [
    ...
    path(
        "shipment/<int:pk>/overviews/",
        views.shipment_overviews,
        name="shipment_overviews",
    ),
    path(
        "shipment/<int:pk>/add-to-send-lst/",
        views.shipment_add_to_send_lst,
        name="shipment_add_to_send_lst",
    ),
